...
public class Application implements Serializable {
    ...
    @NonNull
    @DatabaseField(foreign = true, foreignAutoRefresh = true, columnName = "customer_id", canBeNull = false)
    ...
    @NonNull
    @DatabaseField(columnName = "package_name", canBeNull = false, unique = true)
