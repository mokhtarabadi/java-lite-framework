...
public class Application implements Serializable {
    ...
    @NonNull @DatabaseField(canBeNull = false, defaultValue = "1")
    private Boolean active;

    @NonNull @DatabaseField(foreign = true, foreignAutoRefresh = true, columnName = "customer_id", canBeNull = false)
    private User customer;

    @NonNull @DatabaseField(canBeNull = false)
    private String name;

    @NonNull @DatabaseField(columnName = "package_name", canBeNull = false, unique = true)
